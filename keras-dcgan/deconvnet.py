...
def vgg16_convnet(weights=None):
    ...
    pool5 = base_model.output
    fc6 = Conv2D(4096, kernel_size=(7, 7), activation='relu', name='fc6')(pool5)
    fc7 = Conv2D(4096, kernel_size=(1, 1), activation='relu', name='fc7')(fc6)
    model = Model(base_model.input, fc7, name='vgg16_convnet')
