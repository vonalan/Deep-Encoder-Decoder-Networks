...
def create_generator_model_old(input_noise_shape, output_image_shape):
...
def create_generator_model(input_noise_shape, output_image_shape):
    ...
    # XBlock 5
    x = Conv2DTranspose(64, (3, 3), strides=(2, 2), activation='relu', padding='same', name='deconv5_3')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv5_2')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv5_1')(x)

    # XBlock 4
    x = Conv2DTranspose(64, (3, 3), strides=(2, 2), activation='relu', padding='same', name='deconv4_3')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv4_2')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv4_1')(x)

    # XBlock 3
    x = Conv2DTranspose(64, (3, 3), strides=(2, 2), activation='relu', padding='same', name='deconv3_3')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv3_2')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv3_1')(x)

    # XBlock 2
    x = Conv2DTranspose(64, (3, 3), strides=(2, 2), activation='relu', padding='same', name='deconv2_2')(x)
    # x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', padding='same', name='deconv2_1')(x)
    x = Conv2DTranspose(64, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv2_1')(x)

    # XBlock 1
    x = Conv2DTranspose(64, (3, 3), strides=(2, 2), activation='relu', padding='same', name='deconv1_2')(x)
    # x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', padding='same', name='deconv1_1')(x)
    # x = Conv2DTranspose(64, (3,3), strides=(1, 1), activation='relu', padding='same', name='deconv1_1')(x)
    # TODO: relu | tanh | sigmoid
    x = Conv2DTranspose(3, (3,3), strides=(1, 1), activation='tanh', padding='same', name='deconv1_1')(x)
...
def create_discriminator_model(input_image_shape, output_noise_shape):
    ...
    # TODO: relu | tanh | sigmoid
    x = Flatten()(x)
    x = Dense(output_noise_shape[0], activation='relu')(x)
...
def deconvnet_old(input_image_shape):
    # replace pool layer with convolutional layer
    # replace unpool layer with stride convolutional layer
...
def deconvnet(input_image_shape):
    ...
    # x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', padding='same', name='deconv1_1')(x)
    # TODO: relu | tanh | sigmoid
    x = Conv2DTranspose(3, (3, 3), strides=(1, 1), activation='relu', padding='same', name='deconv1_1')(x)
...
def test_deconvnet(model):
    ...
    for i, image in enumerate(os.listdir(image_dir)):
        ...
        cv2.imwrite('../outputs/test_deconvnet_%d.jpg'%(i), pred_image[0])
...
if __name__ == "__main__":
    ...
    deconvnet_model = deconvnet((224,224,3))
    for i, layer in enumerate(deconvnet_model.layers):
        print(i, '---', layer.name, '---', layer.input_shape, '---', layer.output_shape)
    test_deconvnet(deconvnet_model)